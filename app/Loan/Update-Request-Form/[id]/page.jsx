...
const EditLoan = () => {
  ...
  const fetchLoanDetails = (id) => {
    return dummyLoans.find((loan) => loan.loanId === id);
    console.log("Fetched Loan Details:", dummyLoans);
  };

  useEffect(() => {
    const loanDetails = fetchLoanDetails(loanID);
    console.log("Loan Details:", loanDetails); // Add this line
    if (loanDetails) {
      setFormData((prev) => ({ ...prev, ...loanDetails }));
    } else {
      console.log("Loan not found with ID:", loanID); // Add this line
    }
  }, [loanID]);
  ...
  const [formData, setFormData] = useState({
    ...
    additionalClientContribution: 0, // ✅ default
    supplierQuote: 0,
    costOfAssetFinancedByTasuwab: 0, // ✅ default
    InstallmentPeriod: 0,
        ...
        <div className="mt-6">
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              ...
              {formData.purpose === "Asset Financing" && (
                <button
            ...
            <div className="grid grid-cols-2 gap-3">
                        ...
                        if (selectedClient) {
                          ...
                          if (existingLoan) {
                            ...
                            setFormData((prev) => ({
                              ...
                              InstallmentPeriod: existingLoan.InstallmentPeriod,
                              businessStartupDate:
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  ...
                  value={
                    formData.purpose
                      ? LoanTypes.find((opt) => opt.value === formData.purpose)
                      : null
                  }
                  onChange={(selectedOption) => {
                    if (
